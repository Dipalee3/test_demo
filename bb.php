...
<div class="header">
		<div class="logo">
			<h1><a href="index.php"><img src="Images/ls1.png" alt=""></a></h1>
		</div>
	</div>
</div>
</div>
...
<p>While the overall number of blood donors in India has grown over the years, women constitute only a tiny 10 percent share owing to health problems like pernicious anaemia and low haemoglobin levels or being underweight</p></span>
	...
	<div class="clear"></div>
        ...
        <div class="clear"></div>-->
        <div>
        <img src="Images/bb.jpg"> <div class="main">
	  	<div >

	  			<h1 style="color:red"> Blood banking is the process that takes place in the lab to make sure that donated blood, or blood products, are safe before they are used in blood transfusions and other medical procedures.<br>
	  			  <center><br>We Provides:</br></h1>


							<center><li style="color:Magenta">Rapid response to urgent requests for blood components</li>
							<li style="color:Magenta">Checking pre-transfusion samples and requests</li>
							<li style="color:Magenta">Assessing of immunological compatibility between donor and patient</li>
							<li style="color:Magenta">Selecting of suitable blood component for each clinical condition</li>
							<li style="color:Magenta">Safe delivery and handling of blood components</li>
							<li style="color:Magenta">Inventory and stock management</li>
							<li style="color:Magenta">Interactions with the blood establishment.</li></center>
</center>
 </h1>
	</div>
</div>
